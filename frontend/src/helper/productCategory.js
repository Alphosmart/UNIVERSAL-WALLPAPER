const productCategory = [
    ...
    { id : 15, label : "Gaming", value : "gaming"},
    { id : 16, label : "Books", value : "books"},
    { id : 17, label : "Furniture", value : "furniture"},
    { id : 18, label : "Clothing", value : "clothing"},
    { id : 19, label : "Sports", value : "sports"},
    { id : 20, label : "Other", value : "other"}
]
