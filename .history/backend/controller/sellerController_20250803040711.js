...
async function getPendingSellerApplications(req, res) {
    try {
        console.log('=== getPendingSellerApplications CALLED ===');
        ...
        // Transform data to match frontend expectations
        const transformedApplications = applications.map(app => {
            console.log('Transforming application for:', app.name);
            console.log('Original businessType:', app.businessType);
            console.log('Original verificationDocuments:', app.verificationDocuments);
            ...
            console.log('Transformed application:', JSON.stringify(transformed, null, 2));
            return transformed;
        });

        console.log('Final transformed applications:', JSON.stringify(transformedApplications, null, 2));
