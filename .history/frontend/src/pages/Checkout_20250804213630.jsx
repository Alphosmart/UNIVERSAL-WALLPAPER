...
import SimpleCountryTest from '../components/SimpleCountryTest';
                        ...
                        {currentStep === 2 && (
                            <div className="bg-white rounded-lg shadow-md p-6">
                                ...
                                <div className="mb-4 p-3 bg-gray-100 rounded text-sm">
                                    <strong>Debug - Current Address:</strong><br />
                                    Country: {shippingAddress.country || 'Not selected'}<br />
                                    State: {shippingAddress.state || 'Not selected'}<br />
                                    City: {shippingAddress.city || 'Not entered'}<br />
                                    Street: {shippingAddress.street || 'Not entered'}
                                </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    {/* Temporary Simple Country Selector for Testing */}
                                    <div className="mt-4">
                                        <label className="block text-sm font-medium text-gray-700 mb-2">
                                            Country (Direct Test) *
                                        </label>
                                        <select
                                            ...
                                            onChange={(e) => {
                                                ...
                                                console.log('Direct test: Country changed to:', newCountry);
                                    ...
                                    {/* Original Country and State Selector */}
                                    <CountryStateSelector
                                        selectedCountry={shippingAddress.country}
                                        selectedState={shippingAddress.state}
                                        onCountryChange={(country) => {
                                            console.log('Checkout: Country changed to:', country);
                                            setShippingAddress(prev => ({
                                                ...prev, 
                                                country: country, 
                                                state: ''
                                        ...
                                        onStateChange={(state) => {
                                            console.log('Checkout: State changed to:', state);
                                            setShippingAddress(prev => ({
                                                ...prev, 
                                                state: state
                                            }));
