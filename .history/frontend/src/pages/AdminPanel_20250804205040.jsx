...
import { FaHome, FaUsers, FaBoxOpen, FaChartBar, FaCog, FaUserCheck, FaShippingFast } from 'react-icons/fa';
    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-4">
        <div className="max-w-4xl w-full">
          <div className="text-center bg-yellow-50 p-8 rounded-lg border border-yellow-200 mb-6">
            ...
            <div className="space-x-4 mb-6">
              ...
              <a 
                href="http://localhost:8080/api/create-admin"
                target="_blank"
