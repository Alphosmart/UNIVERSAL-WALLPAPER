        ...
        <div className="bg-white p-2 py-5 w-full max-w-md mx-auto">
          ...
          <form>
            ...
            <div>
              ...
              <Link to="/forgot-password" className="text-blue-500 block text-right">Forgot Password ?</Link>
              <Link to="/register" className="text-blue-500 block text-right">Register
              </Link>
