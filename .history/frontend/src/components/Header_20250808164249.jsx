...
const Header = memo(() => {
  ...
  const sellerMenuItems = useMemo(() => {
    ...
    if (user.sellerStatus === 'verified') {
      return (
        <>
          <Link to={'/seller-dashboard'} className='whitespace-nowrap hover:bg-slate-100 p-2' onClick={closeMenu}>
            Seller Dashboard
          </Link>
          <Link to={'/my-products'} className='whitespace-nowrap hover:bg-slate-100 p-2' onClick={closeMenu}>
            My Products
          </Link>
          <Link to={'/seller-orders'} className='whitespace-nowrap hover:bg-slate-100 p-2' onClick={closeMenu}>
            My Orders
          </Link>
            ...
            {menuDisplay && (
              <div className='absolute bg-white bottom-0 top-11 h-fit p-2 shadow-lg rounded'>
                <nav>
                  ...
                  <Link to={'/my-orders'} className='whitespace-nowrap hover:bg-slate-100 p-2' onClick={closeMenu}>
                    My Orders
                  </Link>
