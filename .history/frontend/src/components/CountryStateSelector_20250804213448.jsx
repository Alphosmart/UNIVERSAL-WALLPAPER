...
const CountryStateSelector = ({ 
  ...
  // Debug logging
  console.log('CountryStateSelector render:', {
    selectedCountry,
    selectedCountryType: typeof selectedCountry,
    countriesCount: countries.length,
    popularCount: popularCountries.length,
    regionsCount: Object.keys(countriesByRegion).length,
    onCountryChangeType: typeof onCountryChange
  });

  useEffect(() => {
    console.log('CountryStateSelector: selectedCountry changed to:', selectedCountry);
  }, [selectedCountry]);
  ...
  const handleCountryChange = (e) => {
    ...
    console.log('onCountryChange function exists:', typeof onCountryChange === 'function');
    
    if (typeof onCountryChange === 'function') {
      onCountryChange(country);
    } else {
      console.error('onCountryChange is not a function!');
    }
    ...
    <div className={`space-y-4 ${className}`}>
      ...
      <div>
        ...
        <select
          ...
          onClick={() => console.log('Country select clicked, current value:', selectedCountry)}
          onFocus={() => console.log('Country select focused, current value:', selectedCountry)}
        >
