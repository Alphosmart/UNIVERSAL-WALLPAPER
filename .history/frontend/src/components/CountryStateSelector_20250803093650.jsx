...
import { getCountriesList, getStatesByCountry, getCitiesByCountry } from '../helper/geographicData';
        ...
        >
          ...
          <optgroup label="African Countries">
            {countries.filter(country => 
              ['Nigeria', 'South Africa', 'Egypt', 'Kenya', 'Ghana', 'Morocco', 'Ethiopia'].includes(country)
            ).map(country => (
