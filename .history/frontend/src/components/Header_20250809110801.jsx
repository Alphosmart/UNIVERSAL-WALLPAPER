...
import { FaChevronDown, FaUser, FaEnvelope, FaSignOutAlt, FaQuestionCircle, FaShippingFast, FaCreditCard, FaUndo, FaComments, FaTi          {!user?._id && (
...
export default Header } from 'react-icons/fa';
